...
<div class="benefits">
    ...
    <div class="container-fluid no-carousel benefits-icon">
    ...
    <div id="carouselExampleControls" class="carousel slide benefits-icon" data-bs-ride="carousel">
    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <div class="padsid-75">
                ...
                <p class="text-perfil padtop-20">El aspirante interesado en cursar el programa académico debe contar con aptitudes e intereses relacionados con el desarrollo de tecnologías, manipulación de equipos informáticos, electrónicos y dispositivos de comunicaciones. También debe ser una persona sensible ante las problemáticas sociales, que se desenvuelve de manera ética y responsable en todas sus acciones.</p>
            </div>
        </div>
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/01-estudiante-software.jpg" alt="">
        </div>
    </div>
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/01-egresado-software.jpg" alt="">
        </div>
        <div class="col-6">
            <div class="padsid-75">
                <p class="title-perfil">Perfil del<br><span>Egresado</span></p>
                <p class="subtitle-perfil">Habilidades y ventajas de estudiar</p>
                <p class="text-perfil padtop-20">El egresado del programa Técnico Laboral en Desarrollo de Software está en la capacidad de apoyar el desarrollo de programas informáticos y paquetes de software, aplicando conceptos, principios y prácticas de programación para la ejecución de proyectos de sistemas en las organizaciones.</p>
            </div>
        </div>
    </div>
</div>
