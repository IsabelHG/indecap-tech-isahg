...
<div class="container-fluid principal">
    <div class="row justify-content-center align-items-center banner-animacion">
        ...
        <div class="col-6 welcome-msg banner-animacion">
    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <div class="padsid-75">
                ...
                <p class="text-perfil padtop-20">El aspirante debe tener habilidades e intereses en el dibujo, diseño, lenguaje audiovisual y manifestar disposición para el trabajo en equipo, el uso de herramientas tecnológicas de edición de imágenes, las actividades creativas y los proyectos audiovisuales.</p>
            </div>
        </div>
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/05-estudiante-animacion.jpg" alt="">
        </div>
    </div>
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/05-egresado-animacion.jpg" alt="">
        </div>
        <div class="col-6">
            <div class="padsid-75">
                <p class="title-perfil">Perfil del<br><span>Egresado</span></p>
                <p class="subtitle-perfil">Habilidades y ventajas de estudiar</p>
                <p class="text-perfil padtop-20">El egresado estará capacitado para asumir y apoyar roles de producción audiovisual en 3D y 2D, desarrollando productos innovadores con dominio de conceptualización, técnicas, diseño, stop motion, producción y postproducción en temas de animaciones, y con capacidad de trabajo en equipo implementando estrategias colaborativas.</p>
            </div>
        </div>
    </div>
</div>
