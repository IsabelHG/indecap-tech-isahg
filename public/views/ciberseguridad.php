...
<!-- HEADER ANIMATION -->
<div class="banner-ciberseguridad" id="principal-animation">
    <div>
...
<div class="container-fluid principal">
    <div class="row justify-content-center align-items-center banner-ciberseguridad">

        <div id="welcome-msg" class="col-6 banner-ciberseguridad">
            <p class="title-italic">¡Comienza ahora!<br><span class="title-black">Técnico Laboral en Ciberseguridad</span></p>
        </div>
    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <div class="padsid-75">
                ...
                <p class="text-perfil padtop-20">El aspirante debe tener habilidades de análisis, pensamiento crítico y ético, comunicación efectiva, trabajo en equipo, proactividad, escucha activa y comprensión de lectura que sirvan para la resolución de problemas complejos.</p>
            </div>
        </div>
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/03-estudiante-ciberseguridad.jpg" alt="">
        </div>
    </div>
    <div class="row justify-content-between align-items-center">
        <div class="col-6">
            <img class="img-perfil" src="../assets/img/03-egresado-ciberseguridad.jpg" alt="">
        </div>
        <div class="col-6">
            <div class="padsid-75">
                <p class="title-perfil">Perfil del<br><span>Egresado</span></p>
                <p class="subtitle-perfil">Habilidades y ventajas de estudiar</p>
                <p class="text-perfil padtop-20">Los egresados del programa tienen la capacidad de planear, organizar, dirigir y controlar los recursos y actividades de los sistemas de información computarizada, procesamiento electrónico de datos, así como la seguridad de la información en todos los niveles, con el objetivo de proteger los sistemas de amenazas internas y externas.</p>
            </div>
        </div>
    </div>
</div>
